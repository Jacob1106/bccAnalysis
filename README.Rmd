...
[![CRAN status](https://www.r-pkg.org/badges/version/bccAnalysis)](https://CRAN.R-project.org/package=bccAnalysis)
...
Install:
devtools::install_github(“YOURUSERNAME/bccAnalysis”)
...
Built with ❤️ using R package development best practices from [Hadley Wickham](https://r-pkgs.org/).
